...
function crearOperador($conn, $input) {
    ...
    // Crear operador con estado inicial 'disponible'
    $sql = "INSERT INTO operador (nombre, especialidad, usuario_id, estado) VALUES (?, ?, ?, 'disponible')";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("ssi", $nombre, $especialidad, $usuario_id);
